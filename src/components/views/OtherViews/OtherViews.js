...
const OtherViews = () => {
  ...
  return (
    <Wrapper moveBy={width / 2}>
      <HeroTesting bgColor="#2C2F37" name="Other1" content={content} />
      <HeroTesting bgColor="#2C2F37" name="Other2" content={content} />
      <HeroTesting bgColor="#2C2F37" name="Other3" content={content} />
    </Wrapper>
  );
};
